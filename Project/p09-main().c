...
void search(INFO *f,int s){
	...
	switch(s){
		...
		//By swithing cases.
		case 1: printf("Enter the PID to be searched\n");scanf("%s",str);searchByPID(f,str,flag);printf("\n");break;
		case 2: printf("Enter the NAME to be searched\n");scanf("%s",str);searchByNAME(f,str,flag);printf("\n");break;
		case 3: printf("Enter the OFFENCE to be searched\n");scanf("%s",str);searchByOFFENCE(f,str,flag);printf("\n");break;
		case 4: printf("Enter the REGION to be searched\n");scanf("%s",str);searchByREGION(f,str,flag);printf("\n");break;
		case 5: printf("Enter the PRISON NAME to be searched\n");scanf("%s",str);searchByPRISONNM(f,str,flag);printf("\n");break;
		case 6: printf("Enter the ARREST DATE to be searched\n");scanf("%s",str);searchByADATE(f,str,flag);printf("\n");break;
		case 7: printf("Enter the RELEASE DATE to be searched\n");scanf("%s",str);searchByRDATE(f,str,flag);printf("\n");break;
...
void modifyADATE(INFO *f) //FUNCTION TO MODIFY ARRIVAL DATE OF PRISONER
{
	...
	{    //String formatting. BY FORMAT DD/MM/YYYY.
		...
		if(d_check==1)	//CHECKING WHETHER THE DATE ENTERED IS VALID OR NOT
		{
			//Copying data into lnkd structure.
		...
		while(1)
		{
			...
			switch(n){
				...
				case '4':
					...
					printf("Enter the choice or field you want to search\n");
					int n=0;
					scanf("%d",&n);
